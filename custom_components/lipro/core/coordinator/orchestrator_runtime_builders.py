"""Internal runtime builder support for the coordinator orchestrator."""
...
class BootstrapCallbacks:
    """Coordinator bootstrap callback bundle."""
...
class BootstrapAssembly:
    """Assembled coordinator bootstrap collaborators before final artifact creation."""
...
class RuntimeCollaboratorBuilder:
    """Build localized runtime collaborators for the coordinator orchestrator."""
    ...
    def __init__(
        ...
        *,
        ...
        """Bind localized runtime-builder dependencies."""
        self.hass = hass
