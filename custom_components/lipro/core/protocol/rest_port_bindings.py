"""Bound REST child-port adapters for the unified protocol root."""
...
class _BoundRestAuthPort:
    """Explicit auth adapter bound to the REST child facade."""
...
class _BoundRestInventoryPort:
    """Explicit inventory adapter bound to the REST child facade."""
...
class _BoundRestStatusPort:
    """Explicit status adapter bound to the REST child facade."""
...
class _BoundRestCommandPort:
    """Explicit command adapter bound to the REST child facade."""
...
class _BoundRestMiscPort:
    """Explicit misc/diagnostics adapter bound to the REST child facade."""
...
class _BoundRestSchedulePort:
    """Explicit schedule adapter bound to the REST child facade."""
...
class _BoundRestDiagnosticsPort:
    """Explicit diagnostics adapter bound to the REST child facade."""
...
__all__ = [
    '_BoundRestAuthPort',
    '_BoundRestCommandPort',
    '_BoundRestDiagnosticsPort',
    '_BoundRestInventoryPort',
    '_BoundRestMiscPort',
    '_BoundRestSchedulePort',
    '_BoundRestStatusPort',
]
