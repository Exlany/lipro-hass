...
def _load_evidence_pack_support() -> tuple[
    type[AiDebugEvidenceCollector], MarkdownBuilder
]:
    try:
        ...
        raise
    collector_type = cast(
        "type[AiDebugEvidenceCollector]", support_module.AiDebugEvidenceCollector
    )
