...
_COMPONENT_EXACT_RULES: tuple[ClassifierRule, ...] = build_exact_rules(
    ExactRuleFamily(
        ...
        residual_rows=(
            ...
            (
                "custom_components/lipro/core/api/diagnostics_api_ota_support.py",
    ...
    ExactRuleFamily(
        ...
        residual_rows=(
            (
                ...
                "root-entry lazy-load / entry-auth / service-registry adapter support home",
            ),
        ),
    ),
    ExactRuleFamily(
        ...
        residual_rows=(
            (
                ...
                "focused diagnostics/developer handler family home for service-router callbacks",
            ),
        ),
    ),
    ExactRuleFamily(
        ...
        residual_rows=(
            (
                ...
                "command-runtime localized outcome support collaborator",
            ),
        ),
    ),
    ExactRuleFamily(
...
_COMPONENT_PREFIX_RULES: tuple[ClassifierRule, ...] = build_prefix_rules(
    PrefixRuleFamily(
        ...
        owner_phase="Phase 2",
        fate="重构",
        prefixes=("custom_components/lipro/core/api/",),
    ),
    PrefixRuleFamily(
        area="Protocol",
        owner_phase="Phase 7.1",
        prefixes=("custom_components/lipro/core/protocol/boundary/",),
    ),
    PrefixRuleFamily(
        area="Protocol",
        owner_phase="Phase 2.5",
        prefixes=("custom_components/lipro/core/protocol/",),
    ),
    PrefixRuleFamily(
        area="Protocol",
        owner_phase="Phase 2.5",
        fate="重构",
        prefixes=("custom_components/lipro/core/mqtt/",),
    ),
    PrefixRuleFamily(
        area="Protocol",
        owner_phase="Phase 2.6",
        prefixes=("custom_components/lipro/core/anonymous_share/",),
    ),
    PrefixRuleFamily(
        area="Assurance",
        owner_phase="Phase 7.3",
        prefixes=("custom_components/lipro/core/telemetry/",),
    ),
    PrefixRuleFamily(
        area="Control",
        owner_phase="Phase 3",
    ...
    PrefixRuleFamily(
        ...
        owner_phase="Phase 4",
        fate="重构",
        prefixes=("custom_components/lipro/core/device/",),
    ),
    PrefixRuleFamily(
        area="Runtime",
        owner_phase="Phase 5",
        fate="重构",
        prefixes=("custom_components/lipro/core/coordinator/",),
    ),
)
...
_TEST_EXACT_RULES: tuple[ClassifierRule, ...] = build_exact_rules(
    ExactRuleFamily(
        area="Assurance",
        owner_phase="Phase 7.4",
        paths=("tests/meta/test_protocol_replay_assets.py",),
    ),
    ExactRuleFamily(
        area="Assurance",
        owner_phase="Phase 8",
        paths=("tests/meta/test_evidence_pack_authority.py",),
    ),
    ExactRuleFamily(
        area="Assurance",
    ...
    ExactRuleFamily(
        ...
        residual_rows=(
            (
                ...
                "route-handoff gsd fast-path smoke guard home",
            ),
            (
                "tests/meta/governance_followup_route_current_milestones.py",
                "governance-route contract + current/latest archive pointer-drift guard",
            ),
        ),
    ),
    ExactRuleFamily(
    ...
    ExactRuleFamily(
        area="Runtime",
        owner_phase="Phase 7.3",
        paths=("tests/integration/test_telemetry_exporter_integration.py",),
    ),
    ExactRuleFamily(
        area="Protocol",
        owner_phase="Phase 7.4",
    ...
    ExactRuleFamily(
        area="Control",
        owner_phase="Phase 27",
        paths=("tests/core/test_init_service_handlers.py",),
    ),
    ExactRuleFamily(
        area="Control", owner_phase="Phase 3 / 7", paths=("tests/core/test_init.py",)
    ),
    ExactRuleFamily(
        area="Cross-cutting",
        owner_phase="Phase 18",
        paths=("tests/core/test_auth_bootstrap.py",),
    ),
    ExactRuleFamily(
        area="Assurance",
        owner_phase="Phase 6",
        paths=("tests/conftest.py", "tests/conftest_shared.py"),
    ),
    ExactRuleFamily(
        area="Assurance",
        owner_phase="Phase 103",
        residual_rows=(
            ...
            (
                ...
                "topicized thin-shell collection hook home",
            ),
            (
    ...
    ExactRuleFamily(
        ...
        residual_rows=(
            (
                ...
                "focused closeout guard home for Phase 123 service-router reconvergence",
            ),
        ),
    ),
    ExactRuleFamily(
        ...
        residual_rows=(
            (
                ...
                "shared follow-up route spec + governance-doc snapshot helper home",
            ),
            (
                "tests/meta/test_phase105_governance_freeze_guards.py",
                "focused latest-archived closeout guard home for Phase 105 governance freeze",
            ),
        ),
    ),
    ExactRuleFamily(
        ...
        residual_rows=(
            (
                ...
                "focused predecessor guard home for Phase 107 REST/auth/status hotspot convergence",
            ),
        ),
    ),
    ExactRuleFamily(
        ...
        residual_rows=(
            (
                ...
                "focused hotspot budget and changed-surface assurance guard home for Phase 113",
            ),
        ),
    ),
    ExactRuleFamily(
        ...
        residual_rows=(
            (
                ...
                "focused open-source surface honesty guard home for Phase 114",
            ),
        ),
    ),
    ExactRuleFamily(
        ...
        residual_rows=(
            (
                ...
                "focused predecessor guard home for Phase 108 MQTT transport-runtime de-friendization",
            ),
        ),
    ),
    ExactRuleFamily(
        ...
        residual_rows=(
            (
                ...
                "focused predecessor guard home for Phase 109 anonymous-share manager inward decomposition",
            ),
        ),
    ),
    ExactRuleFamily(
...
_TEST_PREFIX_RULES: tuple[ClassifierRule, ...] = build_prefix_rules(
    PrefixRuleFamily(
        area="Assurance",
        owner_phase="Phase 6",
        prefixes=("tests/meta/", "tests/snapshots/", "tests/helpers/"),
    ),
    PrefixRuleFamily(
        area="Assurance",
        owner_phase="Phase 8",
        prefixes=("tests/harness/evidence_pack/",),
    ),
    PrefixRuleFamily(
        area="Assurance", owner_phase="Phase 7.4", prefixes=("tests/harness/protocol/",)
    ),
    PrefixRuleFamily(
        area="Protocol", owner_phase="Phase 2.5 / 6", prefixes=("tests/core/mqtt/",)
    ),
    PrefixRuleFamily(
        area="Runtime",
        owner_phase="Phase 5 / 6",
        prefixes=("tests/core/coordinator/", "tests/integration/"),
    ),
    PrefixRuleFamily(
        area="Protocol", owner_phase="Phase 2", prefixes=("tests/core/api/",)
    ),
    PrefixRuleFamily(
        area="Assurance", owner_phase="Phase 7.3", prefixes=("tests/core/telemetry/",)
    ),
    PrefixRuleFamily(
        area="Domain",
        owner_phase="Phase 4",
    ...
    PrefixRuleFamily(
        area="Control",
        owner_phase="Phase 3 / 7",
        prefixes=("tests/services/", "tests/flows/"),
    ),
)
...
_SCRIPT_EXACT_RULES: tuple[ClassifierRule, ...] = build_exact_rules(
    ExactRuleFamily(
        area="Assurance",
        owner_phase="Phase 8",
        paths=("scripts/export_ai_debug_evidence_pack.py",),
    ),
    ExactRuleFamily(
        area="Assurance",
        owner_phase="Phase 79 / 105",
        residual_rows=(
            (
                ...
                "registry shared type + row/family builder home",
            ),
            (
...
_SCRIPT_PREFIX_RULES: tuple[ClassifierRule, ...] = build_prefix_rules(
    PrefixRuleFamily(
        area="Assurance", owner_phase="Phase 6 / 7", prefixes=("scripts/",)
    ),
)


def _match_exact_rule(
    path: str, rules: Sequence[ClassifierRule]
) -> FileGovernanceRow | None:
