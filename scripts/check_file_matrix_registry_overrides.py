...
BASE_OVERRIDE_TRUTH_FAMILIES = (
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "status fallback outward home with support-backed binary-split implementation",
            ),
        ),
    ),
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "protocol-facing runtime service surface",
            ),
        ),
    ),
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "developer diagnostics glue + typed helper home",
            ),
        ),
    ),
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "thin daily runnable shell for topicized toolchain truth suites",
            ),
        ),
    ),
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "REST request-gateway collaborator home",
            ),
            (
    ...
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "public status orchestration home",
            ),
        ),
    ),
    OverrideTruthFamily(
    ...
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "RestSessionState formal REST session-state home",
            ),
        ),
    ),
    OverrideTruthFamily(
        ...
        rows=(
            ...
            (
                ...
                "formal protocol root with localized REST/MQTT child-façade wiring",
            ),
        ),
    ),
    OverrideTruthFamily(
    ...
    OverrideTruthFamily(
        ...
        fate="重构",
        rows=(("custom_components/lipro/core/api/__init__.py", "-"),),
    ),
    OverrideTruthFamily(
        area="Protocol",
        ...
        rows=(
            (
                ...
                "concrete MQTT transport home with explicit runtime owner/state contract projection; package no-export keeps locality explicit",
            ),
        ),
    ),
    OverrideTruthFamily(
    ...
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "package export intentionally minimal; no concrete transport export",
            ),
        ),
    ),
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "shared helper root for topicized init service-handler regressions",
            ),
        ),
    ),
    OverrideTruthFamily(
        area="Assurance",
        owner_phase="Phase 6 / 77 / 79 / 105",
        fate="保留",
        rows=(
            (
                "tests/meta/governance_contract_helpers.py",
                "shared governance route/doc helper home",
            ),
            (
                "tests/meta/governance_current_truth.py",
                "governance-route contract + shared current/latest archive truth helper",
            ),
            (
                "tests/meta/test_version_sync.py",
                "version/runtime metadata sync guard home",
            ),
        ),
    ),
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "shared promoted-phase-asset helper home",
            ),
            (
                "tests/meta/test_governance_bootstrap_smoke.py",
                "focused bootstrap smoke guard home",
            ),
        ),
    ),
    OverrideTruthFamily(
        area="Assurance",
        owner_phase="Phase 27 / 44 / 49 / 77 / 88 / 105",
        fate="保留",
        rows=(
            (
                "tests/meta/test_governance_closeout_guards.py",
                "closeout + promoted-asset manifest smoke anchor + milestone-freeze exit-contract bridge",
            ),
        ),
    ),
    OverrideTruthFamily(
        area="Assurance",
        owner_phase="Phase 88",
        fate="保留",
        rows=(
            (
                "tests/meta/test_phase88_governance_quality_freeze_guards.py",
                "focused guard home for phase-88 governance/evidence freeze",
            ),
        ),
    ),
    OverrideTruthFamily(
        area="Protocol",
        owner_phase="Phase 2 / 85 / 87",
        fate="保留",
        rows=(
            (
                "tests/core/api/test_api_diagnostics_service.py",
                "thin anchor after diagnostics API hotspot topicization",
            ),
            (
                "tests/core/api/test_protocol_contract_matrix.py",
                "thin anchor after protocol-contract hotspot topicization",
            ),
        ),
    ),
    OverrideTruthFamily(
        area="Protocol",
        owner_phase="Phase 87",
        fate="保留",
        rows=(
            (
                "tests/core/api/test_api_diagnostics_service_support.py",
                "local inward helper home for diagnostics API topical suites",
            ),
        ),
    ),
    OverrideTruthFamily(
        area="Runtime",
        owner_phase="Phase 5 / 6 / 85 / 87",
        fate="保留",
        rows=(
            (
                "tests/core/coordinator/runtime/test_mqtt_runtime.py",
                "thin shell after MQTT runtime hotspot topicization",
            ),
        ),
    ),
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "local support helper home for topicized MQTT runtime suites",
            ),
        ),
    ),
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "focused no-regrowth guard home for Phase 87 assurance hotspot topicization",
            ),
        ),
    ),
    OverrideTruthFamily(
    ...
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "public router shell over focused handler/support collaborators",
            ),
        ),
    ),
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "shared helper / cross-surface smoke anchor",
            ),
        ),
    ),
    OverrideTruthFamily(
    ...
    OverrideTruthFamily(
        area="Assurance",
        owner_phase="Phase 33 / 77 / 79",
        fate="保留",
        rows=(
            (
                "tests/meta/test_governance_guards.py",
                "inventory / policy governance topic root",
            ),
            (
                "tests/meta/test_governance_release_contract.py",
                "release/governance workflow anchor suite",
            ),
        ),
    ),
    OverrideTruthFamily(
        ...
        rows=(
            ...
            (
                ...
                "schema-focused init regression home",
            ),
        ),
    ),
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "typed command-result contract classification / retry / delayed-refresh policy home",
            ),
        ),
    ),
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "REST decoder canonicalization helper home",
            ),
    ...
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "typed snapshot container + rejection contract home",
            ),
            (
                "custom_components/lipro/core/coordinator/runtime/mqtt/adapters.py",
                "MQTT callback adapter helper home",
            ),
        ),
    ),
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "thin shell after phase-history topicization",
            ),
        ),
    ),
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "shared helper root for topicized init runtime regressions",
            ),
        ),
    ),
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "REST endpoint operations collaborator home",
            ),
            (
                "custom_components/lipro/core/protocol/mqtt_facade.py",
                "MQTT child façade home under the unified protocol root",
            ),
            (
    ...
    OverrideTruthFamily(
        area="Runtime",
        owner_phase="Phase 90",
        fate="重构",
        rows=(
            (
                "custom_components/lipro/core/coordinator/runtime/command_runtime.py",
                "formal command-runtime orchestration home with inward trace / failure helpers and support-backed request / failure helpers",
            ),
            (
    ...
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "protected thin HA root adapter / lazy wiring shell",
            ),
            (
    ...
    OverrideTruthFamily(
        area="Assurance",
        owner_phase="Phase 89",
        fate="保留",
        rows=(
            (
                "scripts/agent_worker.py",
                "retired fail-fast migration stub only; not the runtime orchestrator",
            ),
            (
    ...
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "structure-preserving anonymous-share sanitizer on shared redaction contract; structure-preserving anonymous-share sanitizer with container/scalar helper split",
            ),
        ),
    ),
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "shared-policy telemetry exporter with pseudonymous alias + marker summary budget contract; shared-policy telemetry exporter with localized sanitize helper split",
            ),
        ),
    ),
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "polling/status/outlet/snapshot orchestration helper home",
            ),
            (
                "tests/core/coordinator/services/test_polling_service.py",
                "polling-service regression home",
            ),
        ),
    ),
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "update-cycle / MQTT-setup / shutdown lifecycle helper home",
            ),
        ),
    ),
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "runtime closeout phase-history topic home",
            ),
            (
                "tests/meta/test_governance_phase_history_topology.py",
                "thin shell after topology phase-history topicization",
            ),
            (
                "tests/meta/governance_phase_history_topology_foundations.py",
                "foundation/early-route phase-history topology topic home",
            ),
            (
                "tests/meta/governance_phase_history_topology_execution.py",
                "archived execution phase-history topology topic home",
            ),
            (
                "tests/meta/governance_phase_history_topology_closeouts.py",
                "closeout/promoted-asset phase-history topology topic home",
            ),
        ),
    ),
    OverrideTruthFamily(
        area="Cross-cutting",
        owner_phase="Phase 112",
        fate="保留",
        rows=(
            (
                "custom_components/lipro/runtime_infra.py",
                "shared runtime infra formal home",
            ),
        ),
    ),
    OverrideTruthFamily(
        area="Cross-cutting",
        owner_phase="Phase 112 / 124",
        fate="保留",
        rows=(
            (
                "custom_components/lipro/entry_auth.py",
                "config-entry auth/bootstrap formal home + persisted auth-seed single-source + token persistence truth",
            ),
        ),
    ),
    OverrideTruthFamily(
        area="Control",
        owner_phase="Phase 3 / 124",
        fate="保留",
        rows=(
            (
                "custom_components/lipro/config_flow.py",
                "HA config-flow thin adapter over localized flow step handlers",
            ),
            (
                "custom_components/lipro/flow/login.py",
                "config-entry login projection consuming entry_auth seed truth",
            ),
            (
                "custom_components/lipro/flow/submission.py",
                "flow submission normalization consuming entry_auth remembered-hash truth",
            ),
            (
                "custom_components/lipro/services/contracts.py",
                "schedule direct-call normalization / result-typing truth home",
            ),
            (
                "custom_components/lipro/services/schedule.py",
                "schedule service helper consuming shared contracts truth",
            ),
        ),
    ),
    OverrideTruthFamily(
        area="Control",
        owner_phase="Phase 124",
        fate="保留",
        rows=(
            (
                "custom_components/lipro/flow/step_handlers.py",
                "localized user / reauth / reconfigure orchestration home behind config_flow thin adapter",
            ),
            (
                "custom_components/lipro/services/schedule_support.py",
                "schedule payload validation / row normalization support home behind shared contracts truth",
            ),
        ),
    ),
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "focused closeout guard home for Phase 124 auth/flow/schedule contract closure",
            ),
        ),
    ),
    OverrideTruthFamily(
    ...
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "thin shell after followup-route topicization",
            ),
            (
                "tests/meta/test_governance_milestone_archives.py",
                "thin shell after milestone-archive topicization",
            ),
            (
                "tests/meta/governance_milestone_archives_assets.py",
                "milestone-archive asset existence topic home",
            ),
            (
                "tests/meta/test_governance_promoted_phase_assets.py",
                "promoted-asset topic suite",
            ),
        ),
    ),
    OverrideTruthFamily(
    ...
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "update background-task topic suite",
            ),
            (
                "tests/platforms/test_update_certification_policy.py",
                "update certification-policy topic suite",
            ),
            (
                "tests/platforms/test_update_entity_refresh.py",
                "update refresh / row-selection topic suite",
            ),
            (
                "tests/platforms/test_update_install_flow.py",
                "update install-flow topic suite",
            ),
        ),
    ),
    OverrideTruthFamily(
    ...
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "HA-facing runtime façade with polling ballast reduced",
            ),
        ),
    ),
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "service / entity-lifecycle smoke shell",
            ),
        ),
    ),
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "neutral shared exponential backoff helper home",
            ),
        ),
    ),
    OverrideTruthFamily(
    ...
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "thin shell after public-surface topicization",
            ),
            (
                "tests/meta/test_dependency_guards.py",
                "thin shell after dependency-guard topicization",
            ),
            (
                "tests/meta/dependency_guard_helpers.py",
                "shared dependency-guard structural-rule helper home",
            ),
            (
                "tests/meta/dependency_guards_policy.py",
                "architecture-policy structural-rule guard family",
            ),
        ),
    ),
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "thin governance checker root; sibling modules own inventory/classification/markdown/validation truth families",
            ),
        ),
    ),
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "checker inventory walk and repo-root helper home",
            ),
            (
                "scripts/check_file_matrix_markdown.py",
                "FILE_MATRIX render and parse helper home",
            ),
            (
                "scripts/check_file_matrix_registry.py",
                "file-governance row registry and classification override home",
            ),
            (
                "scripts/check_file_matrix_validation.py",
                "file-governance drift validators and run_checks home",
            ),
            (
                "tests/meta/toolchain_truth_checker_paths.py",
                "checker-path and local-develop smoke truth family",
            ),
            (
                "tests/meta/toolchain_truth_ci_contract.py",
                "CI lane, pre-push, lint, and pytest contract truth family",
            ),
            (
                "tests/meta/toolchain_truth_python_stack.py",
                "Python pin, devcontainer, and pre-commit toolchain truth family",
            ),
            (
                "tests/meta/toolchain_truth_release_contract.py",
                "release workflow and identity-evidence truth family",
            ),
            (
                "tests/meta/toolchain_truth_testing_governance.py",
                "testing-map and derived-governance topology truth family",
            ),
        ),
    ),
    OverrideTruthFamily(
        ...
        rows=(
            (
                ...
                "device-refresh filter-semantics topic home",
            ),
            (
                "tests/core/test_device_refresh_parsing.py",
                "device-refresh parsing/normalization topic home",
            ),
            (
                "tests/core/test_device_refresh_runtime.py",
                "device-refresh runtime decision topic home",
            ),
            (
                "tests/core/test_device_refresh_snapshot.py",
                "device-refresh snapshot-builder topic home",
            ),
        ),
    ),
    OverrideTruthFamily(
        area="Cross-cutting",
        owner_phase="Phase 7 / 74",
        fate="保留",
        rows=(
            (
                "tests/core/test_share_client.py",
                "thin shell after ShareWorkerClient topicization",
            ),
            (
                "tests/core/test_share_client_support.py",
                "shared helper root for ShareWorkerClient topicized suites",
            ),
            (
                "tests/core/test_share_client_primitives.py",
                "ShareWorkerClient primitive/token topic home",
            ),
            (
                "tests/core/test_share_client_refresh.py",
                "ShareWorkerClient token-refresh topic home",
            ),
            (
                "tests/core/test_share_client_submit.py",
                "ShareWorkerClient submit/outcome topic home",
            ),
            (
                "tests/core/test_share_client_boundary.py",
                "ShareWorkerClient external-boundary proof home",
            ),
        ),
    ),
    OverrideTruthFamily(
        area="Runtime",
        owner_phase="Phase 5 / 6 / 74",
        fate="保留",
        rows=(
            (
                "tests/core/coordinator/runtime/test_command_runtime.py",
                "thin shell after CommandRuntime topicization",
            ),
            (
                "tests/core/coordinator/runtime/test_command_runtime_support.py",
                "shared helper root for CommandRuntime topicized suites",
            ),
            (
                "tests/core/coordinator/runtime/test_command_runtime_builder_retry.py",
                "CommandRuntime builder/retry topic home",
            ),
            (
                "tests/core/coordinator/runtime/test_command_runtime_sender.py",
                "CommandRuntime sender topic home",
            ),
            (
                "tests/core/coordinator/runtime/test_command_runtime_confirmation.py",
                "CommandRuntime confirmation topic home",
            ),
            (
                "tests/core/coordinator/runtime/test_command_runtime_orchestration.py",
                "CommandRuntime orchestration topic home",
            ),
        ),
    ),
    OverrideTruthFamily(
        ...
        rows=(
            ...
            (
                "custom_components/lipro/core/coordinator/runtime/room_sync_runtime.py",
                "shadow helper",
            ),
            (
    ...
    OverrideTruthFamily(
        area="Assurance",
        owner_phase="Phase 49 / 77 / 80",
        fate="保留",
        rows=(
            (
                "tests/meta/governance_milestone_archives_truth.py",
                "milestone-archive authority/pointer truth topic home",
            ),
            (
                "tests/meta/governance_milestone_archives_ordering.py",
                "milestone-archive snapshot ordering + historical-route topic home",
            ),
        ),
    ),
    OverrideTruthFamily(
        area="Assurance",
        owner_phase="Phase 40 / 43 / 50 / 53 / 68",
        fate="保留",
        rows=(
            (
                "tests/meta/dependency_guards_service_runtime.py",
                "service/runtime dependency-story guard family",
            ),
        ),
    ),
    OverrideTruthFamily(
        area="Assurance",
        owner_phase="Phase 40 / 52 / 57",
        fate="保留",
        rows=(
            (
                "tests/meta/dependency_guards_protocol_contracts.py",
                "protocol/schedule dependency-story guard family",
            ),
        ),
    ),
    OverrideTruthFamily(
        area="Assurance",
        owner_phase="Phase 48 / 49 / 54 / 55 / 56 / 58 / 62",
        fate="保留",
        rows=(
            (
                "tests/meta/dependency_guards_review_ledgers.py",
                "dependency-note / verification / naming topic guard family",
            ),
        ),
    ),
    OverrideTruthFamily(
        area="Assurance",
        owner_phase="Phase 44 / 60",
        fate="保留",
        rows=(
            (
                "tests/meta/toolchain_truth_docs_fast_path.py",
                "docs fast-path, continuity, and machine-readable governance truth family; toolchain + docs navigation + terminology truth guard home",
            ),
        ),
    ),
)
...
PHASE_79_OVERRIDE_TRUTH_FAMILIES = (
    OverrideTruthFamily(
        area="Assurance",
        owner_phase="Phase 79",
        fate="保留",
        rows=(
            (
                "scripts/check_file_matrix_registry_shared.py",
                "registry shared type + row builder home",
            ),
            (
                "scripts/check_file_matrix_registry_overrides.py",
                "registry override-family home",
            ),
            (
                "scripts/check_file_matrix_registry_classifiers.py",
                "registry classifier-rule home",
            ),
            (
                "tests/meta/test_governance_release_docs.py",
                "release/docs topic suite home",
            ),
            (
                "tests/meta/test_governance_release_continuity.py",
                "release continuity/custody topic suite home",
            ),
        ),
    ),
    OverrideTruthFamily(
        area="Assurance",
        owner_phase="Phase 94 / 95 / 96 / 97 / 98 / 99 / 100 / 101 / 102",
        fate="保留",
        rows=(
            (
            ...
            (
                ...
                "status fallback local recursion/logging support collaborator",
            ),
            (
                "custom_components/lipro/core/api/schedule_service_support.py",
                "schedule-service local candidate batching/timeout/request support collaborator",
            ),
            (
                "custom_components/lipro/core/coordinator/runtime/command_runtime_support.py",
                "command-runtime local request/summary support collaborator",
            ),
            (
                "custom_components/lipro/core/coordinator/runtime/mqtt_runtime_support.py",
                "MQTT-runtime local transport/notification/background-task support collaborator",
            ),
            (
                "tests/meta/test_phase94_typed_boundary_guards.py",
                "focused no-regrowth guard home for Phase 94 typed payload contraction",
            ),
            (
            ...
            (
                ...
                "focused predecessor guard home for Phase 98 reactivation / carry-forward closure",
            ),
            (
                "tests/meta/test_phase99_runtime_hotspot_support_guards.py",
                "focused predecessor guard home for Phase 99 runtime hotspot support extraction / governance freeze",
            ),
            (
                "tests/meta/test_phase100_runtime_schedule_support_guards.py",
                "focused predecessor guard home for Phase 100 MQTT/runtime schedule support extraction / governance freeze",
            ),
            (
            ...
            (
                ...
                "focused archived-continuity guard home for Phase 102 governance portability / verification stratification / open-source continuity hardening",
            ),
        ),
    ),
    OverrideTruthFamily(
        area="Protocol",
        owner_phase="Phase 101",
        fate="保留",
        rows=(
            (
                "custom_components/lipro/core/anonymous_share/manager_submission.py",
                "anonymous-share submit-flow inward collaborator home",
            ),
            (
                "custom_components/lipro/core/protocol/boundary/rest_decoder.py",
                "REST boundary decoder family home",
            ),
            (
                "custom_components/lipro/core/api/mqtt_api_service.py",
                "MQTT-config boundary-truth reuse helper",
            ),
            (
                "custom_components/lipro/core/api/rest_facade_endpoint_methods.py",
                "REST child-facing typed endpoint wording helper",
            ),
        ),
    ),
)
...
OVERRIDE_TRUTH_FAMILIES = (
    BASE_OVERRIDE_TRUTH_FAMILIES + PHASE_79_OVERRIDE_TRUTH_FAMILIES
)
