...
> Current route note / 当前路线说明：maintainer continuity currently follows `v1.33 active milestone route / starting from latest archived baseline = v1.32`; current handoff = `active / phase 119 complete; closeout-ready (2026-04-01)`, default next command = `$gsd-complete-milestone v1.33`; live selector truth stays in `.planning/{PROJECT,ROADMAP,REQUIREMENTS,STATE}.md`, while `.planning/MILESTONES.md` remains archive chronology only.
...
- Canonical route-selector family: `.planning/{PROJECT,ROADMAP,REQUIREMENTS,STATE}.md` (`v1.33 active milestone route / starting from latest archived baseline = v1.32`; current handoff = `active / phase 119 complete; closeout-ready (2026-04-01)`; default next = `$gsd-complete-milestone v1.33`)
- Canonical latest archived evidence index: `.planning/reviews/V1_32_EVIDENCE_INDEX.md`
- Canonical archived verdict home: `.planning/v1.32-MILESTONE-AUDIT.md` (pull-only evidence verdict, not current route truth)
...
4. Residual/governance closeout tables, `CHANGELOG.md`, `.planning/reviews/V1_32_EVIDENCE_INDEX.md`, and `.planning/v1.32-MILESTONE-AUDIT.md` are updated when the release carries architectural cleanup or release-route wording changes.
...
- If the release contains troubleshooting, public-entry, or runbook changes, ensure those docs still point at each other, at `.planning/reviews/V1_32_EVIDENCE_INDEX.md`, at `.planning/v1.32-MILESTONE-AUDIT.md`, and at the canonical public entry points.
