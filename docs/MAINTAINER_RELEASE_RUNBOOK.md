...
- Canonical active-route selector family: `.planning/{PROJECT,ROADMAP,REQUIREMENTS,STATE}.md` (`v1.32 active milestone route / starting from latest archived baseline = v1.31`; current handoff = `Phase 118 complete / closeout-ready`; default next = `$gsd-complete-milestone v1.32`)
