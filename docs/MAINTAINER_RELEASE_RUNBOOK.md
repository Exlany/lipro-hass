...
- Canonical v1.4 closeout evidence pointer: `.planning/reviews/V1_4_EVIDENCE_INDEX.md`
...
4. Residual/governance closeout tables and `.planning/reviews/V1_4_EVIDENCE_INDEX.md` are updated when the release carries architectural cleanup.
...
- If the release contains troubleshooting, public-entry, or runbook changes, ensure those docs still point at each other, at `.planning/reviews/V1_4_EVIDENCE_INDEX.md`, and at the canonical public entry points.
