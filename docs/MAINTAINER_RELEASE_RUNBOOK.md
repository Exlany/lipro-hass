...
- Canonical latest closeout evidence pointer: `.planning/reviews/V1_5_EVIDENCE_INDEX.md`
...
4. Residual/governance closeout tables and `.planning/reviews/V1_5_EVIDENCE_INDEX.md` are updated when the release carries architectural cleanup.
