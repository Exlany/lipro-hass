...
4. Residual/governance closeout tables, `CHANGELOG.md`, `.planning/reviews/V1_30_EVIDENCE_INDEX.md`, and `.planning/v1.30-MILESTONE-AUDIT.md` are updated when the release carries architectural cleanup or release-route wording changes.
