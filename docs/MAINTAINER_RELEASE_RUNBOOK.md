...
- Canonical latest archived evidence index: `.planning/reviews/V1_26_EVIDENCE_INDEX.md`
- Canonical archived verdict home: `.planning/v1.26-MILESTONE-AUDIT.md` (pull-only evidence verdict, not current route truth)
...
4. Residual/governance closeout tables, `CHANGELOG.md`, `.planning/reviews/V1_26_EVIDENCE_INDEX.md`, and `.planning/v1.26-MILESTONE-AUDIT.md` are updated when the release carries architectural cleanup or release-route wording changes.
...
- If the release contains troubleshooting, public-entry, or runbook changes, ensure those docs still point at each other, at `.planning/reviews/V1_26_EVIDENCE_INDEX.md`, at `.planning/v1.26-MILESTONE-AUDIT.md`, and at the canonical public entry points.
