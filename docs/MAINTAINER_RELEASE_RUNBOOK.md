...
> Current route note / 当前路线说明：maintainer continuity now follows the stable selector family `.planning/{PROJECT,ROADMAP,REQUIREMENTS,STATE,MILESTONES}.md`; today it resolves to `v1.42 active milestone route / starting from latest archived baseline = v1.41`, current status = `active / phase 138 complete; closeout-ready (2026-04-02)`, default next command = `$gsd-complete-milestone v1.42`. Latest archived evidence remains pull-only: `.planning/reviews/V1_41_EVIDENCE_INDEX.md` + `.planning/v1.41-MILESTONE-AUDIT.md`.
...
- Canonical route-selector family: `.planning/baseline/GOVERNANCE_REGISTRY.json::planning_route` → `.planning/{PROJECT,ROADMAP,REQUIREMENTS,STATE,MILESTONES}.md` (registry-owned current selector family; current resolution = `v1.42 active milestone route / starting from latest archived baseline = v1.41`; current status = `active / phase 138 complete; closeout-ready (2026-04-02)`; default next = `$gsd-complete-milestone v1.42`)
- Canonical latest archived evidence index: `.planning/reviews/V1_41_EVIDENCE_INDEX.md`
- Canonical latest archived milestone audit: `.planning/v1.41-MILESTONE-AUDIT.md` (pull-only evidence verdict, not current route truth)
