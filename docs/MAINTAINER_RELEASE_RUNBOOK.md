...
- Canonical route-selector family: `.planning/{PROJECT,ROADMAP,REQUIREMENTS,STATE,MILESTONES}.md` (stable current selector family; current resolution = `no active milestone route / latest archived baseline = v1.34`; default next = `$gsd-new-milestone`)
