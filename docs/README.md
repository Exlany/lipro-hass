...
- **对外入口**：贡献者契约统一收敛到 `CONTRIBUTING.md`、`.github/pull_request_template.md`、`.github/ISSUE_TEMPLATE/*.yml` 与 `SECURITY.md`；`docs/TROUBLESHOOTING.md` 与 `SUPPORT.md` 继续作为 public troubleshooting/support follow-up routes，而 `docs/MAINTAINER_RELEASE_RUNBOOK.md` 仍仅承担 maintainer appendix，不属于 public first hop。
