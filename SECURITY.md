...
The contributor and issue templates assume a minimum supported Home Assistant version of `2026.2.3`.
贡献说明与 Issue 模板统一以 `2026.2.3` 作为最低支持的 Home Assistant 版本口径。
