...
def test_phase_1_truth_endpoints_are_not_duplicated_into_external_boundary_fixtures() -> (
    None
):
    external_boundary_dir = (
        FIXTURE_DIR.parent / "external_boundaries" / "diagnostics_capabilities"
    )
