...
def test_state_service_exposes_device_accessors() -> None:
    ...
    coordinator._state_runtime.get_device_by_serial.return_value = device
    coordinator._state_runtime.get_device_by_id.return_value = device
    ...
    coordinator._state_runtime.get_device_by_serial.assert_called_once_with("dev1")
    coordinator._state_runtime.get_device_by_id.assert_called_once_with("dev1")
