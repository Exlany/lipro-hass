    ...
    def test_coordinator_consumes_named_bootstrap_artifact(
        ...
        service_layer = CoordinatorServiceLayer(
            command_service=cast(
                "CoordinatorCommandService", MagicMock(name="command_service")
            ),
            mqtt_service=cast("CoordinatorMqttService", MagicMock(name="mqtt_service")),
            state_service=cast(
                "CoordinatorStateService", MagicMock(name="state_service")
            ),
            polling_service=cast(
                "CoordinatorPollingService", MagicMock(name="polling_service")
            ),
            schedule_service=cast(
                "CoordinatorScheduleService", MagicMock(name="schedule_service")
            ),
        ...
        assert (
            coordinator.device_refresh_service is service_layer.device_refresh_service
        )
