...
def test_update_trace_with_response_empty_message_becomes_none() -> None:
    trace: dict[str, object] = {}
    update_trace_with_response(trace, {"code": 0, "message": " \n\r\t "})

    assert trace["response_message"] is None
