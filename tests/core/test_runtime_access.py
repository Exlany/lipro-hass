...
def test_iter_runtime_entry_coordinators_skips_entries_without_runtime_data(
    hass,
) -> None:
...
def test_build_runtime_diagnostics_projection_uses_view_facts_without_runtime_backdoor() -> (
    None
):
    coordinator = SimpleNamespace(
        update_interval=None,
