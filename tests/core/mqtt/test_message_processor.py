...
def test_message_processor_returns_payload_unavailable_for_unexpected_raw_payload() -> (
    None
):
    processor = MqttMessageProcessor("biz001")
...
def test_message_processor_returns_message_processing_error_for_parse_failures() -> (
    None
):
    processor = MqttMessageProcessor("biz001")
    captured: list[Exception] = []
