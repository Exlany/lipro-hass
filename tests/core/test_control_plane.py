...
def test_iter_runtime_entry_coordinators_preserves_entry_coordinator_pairs(
    hass,
) -> None:
    from custom_components.lipro.control.runtime_access import (
...
def test_find_runtime_device_and_coordinator_prefers_formal_lookup_helpers(
    hass,
) -> None:
    from custom_components.lipro.control.runtime_access import (
...
@pytest.mark.asyncio
async def test_service_router_support_raises_when_runtime_device_is_missing(
    hass,
) -> None:
    import re
