...
class TestInitServiceHandlerSchedules(_InitServiceHandlerBase):
    ...
    async def test_get_schedules_formats_response(self, hass) -> None:
        ...
        coordinator.protocol_service.async_get_device_schedules_for_device = (
            client.get_device_schedules
        )
        coordinator.protocol_service.async_add_device_schedule_for_device = (
            client.add_device_schedule
        )
        coordinator.protocol_service.async_delete_device_schedules_for_device = (
            client.delete_device_schedules
        )
