...
class TestBrightnessEdgeCases:
    ...
    def test_brightness_at_boundaries(self):
        ...
        assert max(MIN_BRIGHTNESS, min(MAX_BRIGHTNESS, MIN_BRIGHTNESS)) == MIN_BRIGHTNESS
        assert max(MIN_BRIGHTNESS, min(MAX_BRIGHTNESS, MAX_BRIGHTNESS)) == MAX_BRIGHTNESS
...
class TestColorTempEdgeCases:
    ...
    def test_color_temp_at_boundaries(self):
        ...
        assert (
            max(MIN_COLOR_TEMP_KELVIN, min(MAX_COLOR_TEMP_KELVIN, MIN_COLOR_TEMP_KELVIN))
            == MIN_COLOR_TEMP_KELVIN
        )
        assert (
            max(MIN_COLOR_TEMP_KELVIN, min(MAX_COLOR_TEMP_KELVIN, MAX_COLOR_TEMP_KELVIN))
            == MAX_COLOR_TEMP_KELVIN
        )
