...
class TestSelectSetupBehavior:
    ...
    async def test_async_setup_entry_creates_expected_entities(
        ...
        assert any(isinstance(entity, LiproHeaterWindDirectionSelect) for entity in captured)
        assert any(isinstance(entity, LiproHeaterLightModeSelect) for entity in captured)
