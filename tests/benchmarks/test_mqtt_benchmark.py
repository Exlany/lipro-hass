...
def test_mqtt_message_processing_benchmark(benchmark) -> None:
    ...
    benchmark(
        ...
        on_message=lambda _device_id, _properties: None,
        invoke_callback=lambda callback, _name, *args: True if callback is None else (callback(*args), True)[1],
        set_last_error=lambda _err: None,
