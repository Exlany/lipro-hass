...
from .governance_current_truth import CURRENT_MILESTONE_STATUS, CURRENT_PHASE_HEADING
...
_PHASE_DIR = (
    _ROOT
    / ".planning/phases/123-service-router-family-reconvergence-control-plane-locality-and-public-architecture-hygiene"
)
...
def test_phase123_codeboundaries_keep_single_non_diagnostics_handler_home() -> None:
    ...
    for path in (
        ...
        / "lipro"
        / "control"
        / "service_router_command_handlers.py",
        _ROOT
        / "custom_components"
        / "lipro"
        / "control"
        / "service_router_schedule_handlers.py",
        _ROOT
        / "custom_components"
        / "lipro"
        / "control"
        / "service_router_share_handlers.py",
        _ROOT
        / "custom_components"
        / "lipro"
        / "control"
        / "service_router_maintenance_handlers.py",
    ):
