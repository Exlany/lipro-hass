...
def test_phase89_governance_cli_roots_consume_script_owned_helpers_only() -> None:
    ...
    assert "sys.path.insert" not in architecture_checker_text
    assert "from scripts.lib.architecture_policy import" in architecture_checker_text
    assert "from scripts.lib.ast_guard_utils import" in architecture_checker_text
    assert "from lib.architecture_policy import" in architecture_checker_text
    assert "from lib.ast_guard_utils import" in architecture_checker_text

    assert "tests.helpers" not in file_matrix_checker_text
    assert "sys.path.insert" not in file_matrix_checker_text
    assert "from scripts.check_file_matrix_inventory import" in file_matrix_checker_text
    assert "from scripts.check_file_matrix_markdown import" in file_matrix_checker_text
    assert "from scripts.check_file_matrix_registry import" in file_matrix_checker_text
    assert "from scripts.check_file_matrix_validation import" in file_matrix_checker_text
    assert "from check_file_matrix_inventory import" in file_matrix_checker_text
    assert "from check_file_matrix_markdown import" in file_matrix_checker_text
    assert "from check_file_matrix_registry import" in file_matrix_checker_text
    assert "from check_file_matrix_validation import" in file_matrix_checker_text
