...
from .governance_current_truth import CURRENT_PHASE, LATEST_ARCHIVED_EVIDENCE_FILENAME
...
def test_phase102_maps_and_ledgers_keep_portability_hardening_visible() -> None:
    ...
    assert (
        "tests/meta/test_phase102_governance_portability_guards.py" in file_matrix_text
    )
    assert (
