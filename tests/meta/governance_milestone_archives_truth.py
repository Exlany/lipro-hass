...
def test_governance_truth_registers_v1_26_latest_archive_pointer() -> None:
    authority_text = (
        _ROOT / ".planning" / "baseline" / "AUTHORITY_MATRIX.md"
    ).read_text(encoding="utf-8")
    public_text = (
    ...
    assert "## v1.26 Terminal Architecture Audit Follow-through, Typed Mapping Retirement & Hotspot Decomposition" in milestones_text
    assert ".planning/reviews/V1_26_EVIDENCE_INDEX.md" in milestones_text
