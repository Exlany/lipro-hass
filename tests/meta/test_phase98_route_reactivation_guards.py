...
_DEVICE_RUNTIME = (
    _ROOT / "custom_components" / "lipro" / "core" / "device" / "device_runtime.py"
)
_PHASE98_DIR = (
    _ROOT
    / ".planning"
...
def test_phase98_outlet_power_formal_primitive_has_no_live_legacy_fallback_story() -> (
    ...
    device_text = _read(_DEVICE_RUNTIME)
    ...
    assert 'device.extra_data.pop("power_info", None)' in device_text
