...
ACTIVE_MILESTONE_STATUS = "active / Phase 74 complete (2026-03-25)"
...
ACTIVE_PHASE = "74"
ACTIVE_PHASE_TITLE = "Legacy auth residual retirement, test topicization, and milestone closeout"
ACTIVE_PHASE_HEADING = f"### Phase {ACTIVE_PHASE}: {ACTIVE_PHASE_TITLE}"
ACTIVE_PHASE_DIR = "74-legacy-auth-residual-retirement-test-topicization-and-milestone-closeout"
CURRENT_ROUTE = "v1.20 active route / Phase 74 complete / latest archived baseline = v1.19"
CURRENT_ROUTE_MODE = "Phase 74 complete"
