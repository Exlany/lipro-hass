...
_ACTIVE = _as_mapping(PLANNING_ROUTE_CONTRACT["active_milestone"])
...
LATEST_ARCHIVED_EVIDENCE_FILENAME = Path(
    _as_str(_LATEST["evidence_path"])
).name
...
HISTORICAL_ARCHIVE_TRANSITION_ROUTE_TRUTH = (
    ...
    "`no active milestone route / latest archived baseline = v1.19`"
)
