...
ACTIVE_MILESTONE_STATUS = "active / Phase 73 complete (2026-03-25)"
ACTIVE_MILESTONE_DEFAULT_NEXT = "$gsd-plan-phase 74"
ACTIVE_MILESTONE_LABEL = f"{ACTIVE_MILESTONE} {ACTIVE_MILESTONE_NAME}"
ACTIVE_PHASE = "73"
ACTIVE_PHASE_TITLE = "Service-family deduplication, diagnostics/helper convergence, and runtime-surface formalization"
ACTIVE_PHASE_HEADING = f"### Phase {ACTIVE_PHASE}: {ACTIVE_PHASE_TITLE}"
ACTIVE_PHASE_DIR = "73-service-family-deduplication-diagnostics-helper-convergence-and-runtime-surface-formalization"
CURRENT_ROUTE = "v1.20 active route / Phase 73 complete / latest archived baseline = v1.19"
CURRENT_ROUTE_MODE = "Phase 73 complete"
