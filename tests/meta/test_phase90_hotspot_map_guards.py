...
def test_phase90_closeout_docs_and_derived_maps_keep_the_freeze_visible() -> None:
    ...
    assert "**Current route:** `v1.27 active route / Phase 100 complete / latest archived baseline = v1.26`" in project_text
    ...
    assert "v1.27 active route / Phase 100 complete / latest archived baseline = v1.26" in state_text
    assert "$gsd-complete-milestone v1.27" in state_text
