...
_SCHEDULE_SERVICE = (
    _ROOT / "custom_components" / "lipro" / "core" / "api" / "schedule_service.py"
)
_SCHEDULE_SUPPORT = (
    _ROOT
    / "custom_components"
