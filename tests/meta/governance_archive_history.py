...
CURRENT_ROUTE_PROSE_FORBIDDEN = (
    ...
    "v1.44 active milestone route / Phase 142 planned / execution-ready / latest archived baseline = v1.43",
    "$gsd-execute-phase 142",
    "active / phase 142 planned; execution-ready (2026-04-04)",
