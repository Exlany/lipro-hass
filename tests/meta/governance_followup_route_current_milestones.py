...
_REQUIREMENT_TRACES_BY_MILESTONE = {
    ...
    "v1.43": (
        ...
        RequirementTrace("HOT-71", "139"),
        RequirementTrace("GOV-94", "139"),
        RequirementTrace("DOC-22", "139"),
        RequirementTrace("TST-59", "139"),
        RequirementTrace("AUD-09", "140"),
        RequirementTrace("GOV-95", "140"),
        RequirementTrace("DOC-23", "140"),
        RequirementTrace("TST-60", "140"),
        RequirementTrace("ARC-49", "141"),
        RequirementTrace("ARC-50", "141"),
        RequirementTrace("ARC-51", "141"),
        RequirementTrace("HOT-72", "141"),
        RequirementTrace("HOT-73", "141"),
        RequirementTrace("GOV-96", "141"),
        RequirementTrace("DOC-24", "141"),
        RequirementTrace("TST-61", "141"),
    ),
    "v1.42": (
        RequirementTrace("ARC-46", "137"),
        RequirementTrace("HOT-67", "137"),
        RequirementTrace("HOT-68", "137"),
        RequirementTrace("HOT-69", "137"),
        RequirementTrace("OBS-01", "138"),
        RequirementTrace("GOV-92", "137"),
        RequirementTrace("DOC-20", "137"),
        RequirementTrace("TST-57", "137"),
        RequirementTrace("ARC-47", "138"),
        RequirementTrace("QLT-59", "138"),
        RequirementTrace("GOV-93", "138"),
        RequirementTrace("DOC-21", "138"),
        RequirementTrace("TST-58", "138"),
    ),
    "v1.41": (
