...
_V1_30_TRACES = (
    ...
    RequirementTrace("TST-37", "110", "Complete"),
    RequirementTrace("QLT-45", "110", "Complete"),
    RequirementTrace("RUN-10", "108"),
    RequirementTrace("HOT-47", "109", "Complete"),
    RequirementTrace("RUN-11", "110", "Complete"),
    RequirementTrace("GOV-70", "110", "Complete"),
)
...
_V1_30_COVERAGE = CoverageSnapshot("v1.30 routed requirements", 8, mapped=8, complete=8, pending=0)
...
def test_machine_readable_route_contracts_point_to_archived_v1_30_and_previous_v1_29() -> None:
    ...
    assert milestones_latest_archived["version"] == "v1.30"
    assert milestones_latest_archived["phase"] == "110"
    assert milestones_previous_archived["version"] == "v1.29"
...
def test_current_v1_30_archived_state_and_archive_pointers_align() -> None:
