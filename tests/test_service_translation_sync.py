...
_STRINGS_JSON_PATH = _ROOT / "custom_components" / "lipro" / "strings.json"
_TRANSLATIONS_EN_PATH = (
    _ROOT / "custom_components" / "lipro" / "translations" / "en.json"
)
_TRANSLATIONS_ZH_HANS_PATH = (
