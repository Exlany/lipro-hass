...
- 维护者附录现已显式指向 latest archived evidence index（`.planning/reviews/V1_26_EVIDENCE_INDEX.md`）与 archived milestone audit（`.planning/v1.26-MILESTONE-AUDIT.md`），保持 release pull-chain 单一路由。
