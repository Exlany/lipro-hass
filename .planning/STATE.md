...
- Latest archived evidence pointer: `.planning/reviews/V1_35_EVIDENCE_INDEX.md`
- Latest archived audit verdict: `.planning/v1.35-MILESTONE-AUDIT.md`
...
- `v1.35` 继续作为 latest archived baseline；evidence index = `.planning/reviews/V1_35_EVIDENCE_INDEX.md`
- `v1.34` 继续作为 previous archived baseline；evidence index = `.planning/reviews/V1_34_EVIDENCE_INDEX.md`
- `Phase 122` 与 `Phase 125` 的 summaries / verification / audit 仍是 v1.35 archived proof，不回写为当前活路线。
