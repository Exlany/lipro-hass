...
**Updated:** 2026-04-04 (v1.43 archived closeout / latest archived evidence aligned)
...
| planning governance-route contract family | `.planning/{PROJECT,ROADMAP,REQUIREMENTS,STATE}.md` 中的 `governance-route` contract blocks，`tests/meta/governance_current_truth.py` | route-contract blocks -> planning tests / handoff guards | active route / latest archived baseline / default-next truth 的 machine-readable formal home；`.planning/MILESTONES.md` 不属于 live selector family，也不由 `GOVERNANCE_REGISTRY.json` 承载 |
