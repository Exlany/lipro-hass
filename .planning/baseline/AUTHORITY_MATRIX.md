...
| machine-readable governance truth | `.planning/baseline/GOVERNANCE_REGISTRY.json` | registry -> public docs / contributor templates / governance tests | 只承载 continuity / install / release trust 等 active governance facts；archive snapshots 与 milestone evidence 不能反向升级成 current truth |
