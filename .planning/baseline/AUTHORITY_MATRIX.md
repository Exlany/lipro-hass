...
**Updated:** 2026-03-22 (Phase 60 tooling truth aligned)
...
| archive milestone snapshots / evidence | `.planning/MILESTONES.md`, `.planning/milestones/*.md`, `.planning/v1.5-MILESTONE-AUDIT.md`, `.planning/v1.6-MILESTONE-AUDIT.md`, `.planning/reviews/V1_5_EVIDENCE_INDEX.md`, `.planning/reviews/V1_6_EVIDENCE_INDEX.md` | archive evidence -> audit / handoff / historical review | 历史追溯与 continuity 证据；不是 active governance truth；latest pull-only closeout pointer 当前是 `V1_6_EVIDENCE_INDEX.md` |
