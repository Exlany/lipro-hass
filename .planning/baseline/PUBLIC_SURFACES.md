...
- `docs/README.md` 与 `docs/MAINTAINER_RELEASE_RUNBOOK.md` 可以显式引用 `V1_19_EVIDENCE_INDEX.md` 作为 latest archive-ready closeout pointer；当前治理状态已切到 `v1.20 active route / Phase 72 planning-ready / latest archived baseline = v1.19`，下一步治理动作是 `$gsd-plan-phase 72`。
