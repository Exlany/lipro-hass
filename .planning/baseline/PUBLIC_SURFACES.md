...
- `docs/README.md` 与 `docs/MAINTAINER_RELEASE_RUNBOOK.md` 可以显式引用 `V1_18_EVIDENCE_INDEX.md` 作为 latest archive-ready closeout pointer；当前无 active milestone route，下一步治理动作是 `$gsd-new-milestone`。
