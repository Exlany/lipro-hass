...
- `.planning/reviews/V1_23_TERMINAL_AUDIT.md` 继续只承担 historical audit artifact 身份；当前 archived-only route / default-next / closeout posture 由 planning docs、`.planning/v1.26-MILESTONE-AUDIT.md`、`.planning/reviews/V1_26_EVIDENCE_INDEX.md`、`VERIFICATION_MATRIX.md` 与 focused governance guards 共同冻结。
