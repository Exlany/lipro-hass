...
- `docs/README.md` 与 `docs/MAINTAINER_RELEASE_RUNBOOK.md` 可以显式引用 `V1_16_EVIDENCE_INDEX.md` 作为 latest archive-ready closeout pointer；当前 active route 是 `v1.17 / Phase 69`，下一步治理动作是 `$gsd-execute-phase 69`。
