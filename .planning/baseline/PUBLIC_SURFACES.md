...
- `docs/README.md` 与 `docs/MAINTAINER_RELEASE_RUNBOOK.md` 可以显式引用 `V1_18_EVIDENCE_INDEX.md` 作为 latest archive-ready closeout pointer；当前 active route 已提升到 `v1.19 / Phase 71 complete / closeout-ready`，下一步治理动作是 `$gsd-complete-milestone v1.19`。
