...
**Updated:** 2026-03-31 (Phase 111 runtime-boundary hardening aligned)
**Alignment:** `v1.31 / Phase 111` baseline/guard truth verified on `2026-03-31` (rule inventory extended for entity/runtime boundary sealing)
...
|--------|----------|------|------------------------|-------------------|----------------------------|-------------|-------------|-------------|
| `ENF-IMP-ENTITY-PROTOCOL-INTERNALS` | Plane | `imports_disjoint` | `custom_components/lipro/binary_sensor.py`<br>`custom_components/lipro/climate.py`<br>`custom_components/lipro/cover.py`<br>`custom_components/lipro/fan.py`<br>`custom_components/lipro/light.py`<br>`custom_components/lipro/select.py`<br>`custom_components/lipro/sensor.py`<br>`custom_components/lipro/switch.py`<br>`custom_components/lipro/update.py`<br>`custom_components/lipro/helpers/platform.py`<br>`custom_components/lipro/entities/*.py` | `custom_components.lipro.core.api`<br>`custom_components.lipro.core.mqtt`<br>`custom_components.lipro.core.protocol.boundary`<br>`custom_components.lipro.core.coordinator` | `-` | `docs/NORTH_STAR_TARGET_ARCHITECTURE.md §2.2`<br>`.planning/baseline/DEPENDENCY_MATRIX.md` | `scripts/check_architecture_policy.py`<br>`tests/meta/test_dependency_guards.py` | none |
| `ENF-IMP-CONTROL-NO-BYPASS` | Plane | `imports_disjoint` | `custom_components/lipro/runtime_infra.py`<br>`custom_components/lipro/diagnostics.py`<br>`custom_components/lipro/system_health.py`<br>`custom_components/lipro/services/registry.py`<br>`custom_components/lipro/control/**/*.py` | `custom_components.lipro.core.api`<br>`custom_components.lipro.core.mqtt`<br>`custom_components.lipro.core.protocol.boundary`<br>`custom_components.lipro.core.coordinator` | `-` | `docs/NORTH_STAR_TARGET_ARCHITECTURE.md §2.2`<br>`.planning/baseline/DEPENDENCY_MATRIX.md` | `scripts/check_architecture_policy.py`<br>`tests/meta/test_dependency_guards.py` | none |
...
| `ENF-ADAPTER-ENTITY-RUNTIME-BRIDGE` | Adapter | `file_contains_disjoint` | `custom_components/lipro/entities/base.py` | `_EntityCoordinatorBridge`<br>`runtime_coordinator`<br>`DataUpdateCoordinator` | `from ..core.coordinator.coordinator import Coordinator`<br>`cast(Coordinator, coordinator)`<br>`CoordinatorEntity[Coordinator]` | `docs/NORTH_STAR_TARGET_ARCHITECTURE.md §2.2`<br>`.planning/baseline/DEPENDENCY_MATRIX.md` | `scripts/check_architecture_policy.py`<br>`tests/meta/test_phase111_runtime_boundary_guards.py` |
| `ENF-BACKDOOR-RUNTIME-ACCESS-NO-RAW-RUNTIME-DATA` | Backdoor | `file_contains_disjoint` | `custom_components/lipro/control/runtime_access.py` | `_build_runtime_entry_view_support`<br>`_iter_runtime_entry_views_support` | `runtime_data`<br>`_get_explicit_member(` | `docs/NORTH_STAR_TARGET_ARCHITECTURE.md §2.2`<br>`.planning/baseline/DEPENDENCY_MATRIX.md` | `scripts/check_architecture_policy.py`<br>`tests/meta/test_phase111_runtime_boundary_guards.py` |
