...
| 20-02-02 | 20-02 | 2 | SIM-03 | MQTT message-envelope regression | `uv run pytest -q tests/core/mqtt/test_mqtt_payload.py tests/core/mqtt/test_message_processor.py tests/core/mqtt/test_client_refactored.py` | ✅ | ⬜ pending |
