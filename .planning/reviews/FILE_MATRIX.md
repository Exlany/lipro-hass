...
| `tests/meta/governance_contract_helpers.py` | Assurance | Phase 6 / 77 | 保留 | shared governance route/doc helper home |
| `tests/meta/governance_current_truth.py` | Assurance | Phase 6 | 保留 | governance-route contract + shared current/latest archive truth helper |
...
| `tests/meta/governance_followup_route_current_milestones.py` | Assurance | Phase 59 | 保留 | governance-route contract + current/latest archive pointer-drift guard |
...
| `tests/meta/test_governance_release_contract.py` | Assurance | Phase 33 / 77 | 保留 | release/docs governance contract guard home |
