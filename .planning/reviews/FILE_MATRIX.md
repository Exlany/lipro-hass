...
| `custom_components/lipro/core/anonymous_share/share_client_submit_attempts.py` | Protocol | Phase 2.6 | 保留 | - |
| `custom_components/lipro/core/anonymous_share/share_client_submit_outcomes.py` | Protocol | Phase 2.6 | 保留 | - |
...
| `custom_components/lipro/core/command/result_support.py` | Cross-cutting | Phase 7 | 保留 | - |
...
| `custom_components/lipro/core/ota/candidate_certification_support.py` | Cross-cutting | Phase 7 | 保留 | - |
...
| `custom_components/lipro/core/protocol/boundary/rest_decoder_family.py` | Protocol | Phase 7.1 | 保留 | - |
| `custom_components/lipro/core/protocol/boundary/rest_decoder_registry.py` | Protocol | Phase 7.1 | 保留 | - |
...
| `custom_components/lipro/core/protocol/boundary/rest_decoder_utility.py` | Protocol | Phase 7.1 | 保留 | - |
...
| `tests/core/coordinator/runtime/test_command_runtime_support_helpers.py` | Runtime | Phase 5 / 6 | 保留 | - |
...
| `tests/meta/governance_followup_route_current_milestones.py` | Assurance | Phase 79 / 105 | 保留 | governance-route contract + current/latest archive pointer-drift guard |
