...
- `Phase 126` 的 Nyquist validation 已通过 `.planning/phases/126-service-router-developer-callback-home-convergence-and-diagnostics-helper-residual-slimming/126-VALIDATION.md` retroactively backfill；`v1.36` 现已具备完整 repo-internal validation asset coverage。
