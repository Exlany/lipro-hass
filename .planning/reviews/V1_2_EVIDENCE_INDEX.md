...
| `23` | governance/docs/release evidence convergence | `23-01~23-03-SUMMARY.md`, `23-VERIFICATION.md` | unified lifecycle truth, public-entry docs sync, release evidence pointer |
| `24` | final audit / milestone bundle / handoff | `24-01~24-03-SUMMARY.md`, `24-VERIFICATION.md` | final repo audit, v1.2 milestone audit, v1.3 handoff |
...
- `archive-ready` 判断以 `.planning/v1.2-MILESTONE-AUDIT.md` 为 verdict home；本索引只负责把证据指针收在一起。
