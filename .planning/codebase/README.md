...
> Snapshot: `2026-03-18`
> Freshness: Phase 32 对齐刷新；本目录只在 `AGENTS.md`、`.planning/{ROADMAP,REQUIREMENTS,STATE}.md`、`.planning/baseline/*.md`、`.planning/reviews/*.md`、`docs/developer_architecture.md` 与当前 CI/release/public-doc truth 所代表的截面上成立。上述真源一旦变化，本目录必须同步刷新或标记为历史观察。
